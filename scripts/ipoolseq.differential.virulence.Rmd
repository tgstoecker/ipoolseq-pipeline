...
knitr::kable(data.table(
  ...
  group.by.knockout(counts.flank.in)[, cor.intercept0(sqrt(n5p), sqrt(n3p))],
  group.by.knockout(counts.flank.out)[, cor.intercept0(sqrt(n5p), sqrt(n3p))],
  group.by.knockout(counts.flank.in)[, cor.intercept0(sqrt(n5p/(1-l5p)), sqrt(n3p/(1-l3p)))],
  group.by.knockout(counts.flank.out)[, cor.intercept0(sqrt(n5p/(1-l5p)), sqrt(n3p/(1-l3p)))])
), digits=3)
```
