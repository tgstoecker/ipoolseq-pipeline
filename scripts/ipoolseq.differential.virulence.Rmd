...
knitr::kable(data.frame(row.names=c("list of insertional knockouts (mutants)",
                        ...
                        report=c("",
                                 paste0("[TRUmiCount report](", basename(snakemake@input$trumicount_pdf_in_5p), ")"),
                                 paste0("[TRUmiCount report](", basename(snakemake@input$trumicount_pdf_in_3p), ")"),
                                 paste0("[TRUmiCount report](", basename(snakemake@input$trumicount_pdf_out_5p), ")"),
                                 paste0("[TRUmiCount report](", basename(snakemake@input$trumicount_pdf_out_3p), ")"),
                                 "")))
```
...
knitr::kable(data.frame(
  ...
  `Input pool` =c(paste0("[FastQC report](", basename(snakemake@input$fastqc_html_in_5p_r1), ")"),
                  paste0("[FastQC report](", basename(snakemake@input$fastqc_html_in_5p_r2), ")"),
                  paste0("[FastQC report](", basename(snakemake@input$fastqc_html_in_3p_r1), ")"),
                  paste0("[FastQC report](", basename(snakemake@input$fastqc_html_in_3p_r2), ")")),
  `Output pool`=c(paste0("[FastQC report](", basename(snakemake@input$fastqc_html_out_5p_r1), ")"),
                  paste0("[FastQC report](", basename(snakemake@input$fastqc_html_out_5p_r2), ")"),
                  paste0("[FastQC report](", basename(snakemake@input$fastqc_html_out_3p_r1), ")"),
                  paste0("[FastQC report](", basename(snakemake@input$fastqc_html_out_3p_r2), ")")),
  check.names=FALSE
))
```
