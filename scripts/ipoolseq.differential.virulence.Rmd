...
Also check the *TRUmiCount report* (found above under *Files*) for details about the performance of the [TRUmiCount](www.cibiv.at/software/trumicount) UMI filtering step.
...
## Differential virulence to the neutral reference set
