...
knitr::kable(data.table(
  `Read 1`=c(paste0("[Input pool](", basename(snakemake@input$fastqc_html_in_r1), ")"),
             paste0("[output pool](", basename(snakemake@input$fastqc_html_out_r1), ")")),
  `Read 2`=c(paste0("[Input pool](", basename(snakemake@input$fastqc_html_in_r2), ")"),
             paste0("[Output pool](", basename(snakemake@input$fastqc_html_out_r2), ")"))
))
```
...
knitr::kable(read.table(snakemake@input$stats_in, header=TRUE, sep="\t", comment.char='', na.strings='-', check.names=FALSE))
```
...
knitr::kable(read.table(snakemake@input$stats_out, header=TRUE, sep="\t", comment.char='', na.strings='-', check.names=FALSE))
```
